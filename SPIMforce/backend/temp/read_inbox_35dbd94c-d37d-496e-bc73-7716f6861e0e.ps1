...
try {
  ...
  if ($results.Count -eq 0) {
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\SPIMForce\\SPIMforce\\backend\\temp\\inbox_77596fd5-d2a4-4de7-b875-7f82b72858de.json', '[]', $utf8NoBom)
  } else {
    $json = $results | ConvertTo-Json -Depth 3 -Compress
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\SPIMForce\\SPIMforce\\backend\\temp\\inbox_77596fd5-d2a4-4de7-b875-7f82b72858de.json', $json, $utf8NoBom)
  }

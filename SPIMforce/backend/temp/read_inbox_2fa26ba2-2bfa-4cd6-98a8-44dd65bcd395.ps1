...
try {
  ...
  if ($results.Count -eq 0) {
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\SPIMForce\\SPIMforce\\backend\\temp\\inbox_33001546-b9e5-4d65-9c5c-4f5f261eb175.json', '[]', $utf8NoBom)
  } else {
    $json = $results | ConvertTo-Json -Depth 3 -Compress
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\SPIMForce\\SPIMforce\\backend\\temp\\inbox_33001546-b9e5-4d65-9c5c-4f5f261eb175.json', $json, $utf8NoBom)
  }

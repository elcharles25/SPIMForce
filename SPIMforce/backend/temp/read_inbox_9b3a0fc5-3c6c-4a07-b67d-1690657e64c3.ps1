...
try {
  ...
  if ($results.Count -eq 0) {
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\SPIMForce\\SPIMforce\\backend\\temp\\inbox_5122bf50-41c2-4283-8526-ad9c4d235e84.json', '[]', $utf8NoBom)
  } else {
    $json = $results | ConvertTo-Json -Depth 3 -Compress
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\SPIMForce\\SPIMforce\\backend\\temp\\inbox_5122bf50-41c2-4283-8526-ad9c4d235e84.json', $json, $utf8NoBom)
  }
